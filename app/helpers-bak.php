...
function getRemainingTargetProfit($item, $highestProfit = false)
{
    $minimumTargetProfit = 250;
    ...
    return ($remainingTP <= $minimumTargetProfit )? $minimumTargetProfit : $remainingTP;
}
