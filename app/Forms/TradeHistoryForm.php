...
class TradeHistoryForm extends Form
{
        ...
        if (!empty($data)) {
            $formButtonsField[] = $this->makeField('cancel-update', 'button', [
                ...
                'attr' => [
                    ...
                    'onclick' => 'window.location.href="'. route('trade.history') .'";'
                ]
            ]);
        }
