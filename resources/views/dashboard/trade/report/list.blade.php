...
@php
    ...
    $enableTradeControls = (isset($enableTradeControls))? $enableTradeControls : true;
@endphp
    <div class="flex filters">
        ...
        <div class="">
            <div class="trade-notifications">
                @if(!empty($notConnectedUnits))
                    <div id="unit-warning" class="mb-4 flex items-center w-full p-4 text-gray-500 bg-white rounded-lg shadow-sm dark:text-gray-400 dark:bg-gray-800" role="alert">
                        ...
                        <div class="ms-3 text-sm font-normal">Not connected PC Units:
                            <strong class="text-white">{{ implode(', ', $notConnectedUnits) }}</strong>.</div>
                    </div>
                @endif
            </div>
...
{{--                                                <select {{ ((!$enableTradeControls)? 'readonly=readonly' : '') }} data-pair_val="symbol" class="border-2 border-gray-600 bg-gray-900 text-gray-300 text-sm block w-full p-2.5">--}}
{{--                                                    @foreach($symbols as $symbol)--}}
{{--                                                        <option value="{{ $symbol }}">{{ $symbol }}</option>--}}
{{--                                                    @endforeach--}}
{{--                                                </select>--}}
                                                <input readonly="readonly" type="text" data-pair_val="symbol" class="border-2 border-gray-600 block dark:bg-gray-900 dark:text-gray-300 w-full">
                                            </div>
                                        </div>
                                        <div class="border-b border-gray-900 flex flex-row">
                                            <div class="label px-3 py-2 w-1/2">Order Amount</div>
                                            <div class="bg-gray-700 w-1/2">
                                                <input {{ ((!$enableTradeControls)? 'readonly=readonly' : '') }} type="number" data-pair_val="order_amount" step="0.01" class="border-2 border-gray-600 block dark:bg-gray-900 dark:text-gray-300 w-full">
                                            </div>
                                        </div>
                                        <div class="border-b border-gray-900 flex flex-row">
                                            ...
                                            <div class="bg-gray-700 w-1/2 relative">
                                                <input type="number" {{ ((!$enableTradeControls)? 'readonly=readonly' : '') }} step="0.01" data-pair_val="tp" class="border-2 border-gray-600 block dark:bg-gray-900 dark:text-gray-300 w-full">
                                        ...
                                        <div class="border-b border-gray-900 flex flex-row">
                                            ...
                                            <div class="bg-gray-700 w-1/2 relative">
                                                <input {{ ((!$enableTradeControls)? 'readonly=readonly' : '') }} type="number" step="0.01" data-pair_val="sl" class="border-2 border-gray-600 block dark:bg-gray-900 dark:text-gray-300 w-full">
...
{{--                                                </select>--}}
                                        ...
                                        <div class="border-b border-gray-900 flex flex-row">
                                            ...
                                            <div class="bg-gray-700 w-1/2 relative">
                                                <input {{ ((!$enableTradeControls)? 'readonly=readonly' : '') }} type="number" step="0.01" data-pair_val="tp" class="border-2 border-gray-600 block dark:bg-gray-900 dark:text-gray-300 w-full">
                                                <span class="converted-tp"></span>
                                            </div>
                                        </div>
                                        <div class="border-b border-gray-900 flex flex-row">
