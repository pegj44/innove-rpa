...
{{--    <div class="border border-gray-700 border-l-0 flex items-center p-3 remove-pair">--}}
    <div class="border border-gray-700 border-l-0 flex items-center p-3 remove-pair {{ (!$canCloseTrade)? 'hidden' : '' }}">
        <a href="#" class="" onclick="cancelPairing(event, {{ $pairedItemData['queue_db_id'] }})">
            <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18 17.94 6M18 18 6.06 6"/>
            </svg>
        </a>
{{--        <form method="post" data-pair_id="{{ $pairedItemData['queue_db_id'] }}" action="{{ route('trade.remove-pair', $pairedItemData['queue_db_id']) }}" style="height: 24px;">--}}
{{--            @csrf--}}
{{--            @method('DELETE')--}}
...
<div id="accordion-paired-collapse-body-{{$index}}" data-queue_group_id="{{ $pairedItemData['queue_db_id'] }}" class="hidden pair-item-accordion" aria-labelledby="accordion-paired-collapse-heading-{{$index}}">
                    ...
                    <div class="relative overflow-x-auto shadow-md">
                        <table data-item="{{ $index }}" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            ...
                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 w-1/2 dark:bg-gray-900">
                                    {{ (isset($pairItem1['symbol'])? $symbols[$pairItem1['symbol']] : '') }}
                                </td>
                            </tr>
                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                <th scope="row" class="bg-gray-50 dark:bg-gray-800 dark:text-white font-medium px-6 py-4 text-gray-900 whitespace-nowrap">
                    ...
                    <div class="relative overflow-x-auto">
                        <table data-item="{{ $index }}" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            ...
                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 w-1/2 dark:bg-gray-900">
                                    {{ (isset($pairItem2['symbol'])? $symbols[$pairItem2['symbol']] : '') }}
                                </td>
                            </tr>
                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                <th scope="row" class="bg-gray-50 dark:bg-gray-800 dark:text-white font-medium px-6 py-4 text-gray-900 whitespace-nowrap">
