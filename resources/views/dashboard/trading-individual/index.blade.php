...
{{--                    <h3 class="mb-5">{{ __('Trade Individuals') }}</h3>--}}
                    ...
                    <a href="{{ route('trading-account.individual.create') }}" class="mb-1 px-3 py-2 text-sm font-medium text-center inline-flex items-center text-white bg-blue-700 rounded-md hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
