    ...
    <div class="p-6 mt-14">
        ...
        <div class="shadow-sm">
            <div class="text-gray-900 dark:text-gray-100 mb-4">
                ...
                @if(empty($items))
                    <div class="text-gray-900 dark:text-gray-100 mb-4">
                        <h3 class="mb-5">{{ __("You have no records added yet. Click ") }} <a href="{{ route('trading-account.credential.funders.accounts.add') }}" class="text-blue-500">{{ __('HERE') }}</a> {{ __('to add a one.') }}</h3>
                    </div>
                @else
