        ...
        @foreach($items as $item)
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                <td class="px-6 py-4 text-right border-r border-gray-600">
                    <a href="{{ route('trading-account.credential.funders.accounts.edit', $item['id']) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                ...
                <td class="px-6 py-4 text-right border-l border-gray-600">
                    <form id="delete-item-{{ $item['id'] }}" method="POST" action="{{ route('trading-account.credential.funders.accounts.delete', $item['id']) }}" class="flex flex-col justify-center" x-data="">
                        @csrf
                        @method('DELETE')
